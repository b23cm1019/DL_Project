...
# ── Ensure venv torchrun takes priority over system torchrun ──────────────────
# This is the root cause of the CUDA version mismatch crash:
# system torchrun at /opt/ohpc/.../bin/torchrun uses system torchvision (cu121)
# even when the venv has PyTorch cu118. Prepending venv bin fixes this.
